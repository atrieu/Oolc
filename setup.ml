...
(* OASIS_START *)
(* DO NOT EDIT (digest: 425450f2df022ee34b3b8f37260788b6) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/atrieu/Oolc";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/atrieu/Oolc.git";
                      src_repo_browser =
                        Some "https://github.com/atrieu/Oolc";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Î\016h\007 \128¸j\011B§\129P_z\156";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
